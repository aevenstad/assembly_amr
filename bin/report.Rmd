...
Genomisk DNA sekvensert med `r sequencing_platform`. Assembly utført via Shovill (med SPAdes assembler), m>
...
\vspace{1em}
Resistensgener basert på kjernedatabasen av Bacterial Antimicrobial Resistance Reference Gene Database Bio>

```{r, include=FALSE}
AMR_out <- AMR_out[, c("Scope", "Type", "Subtype", "Element.symbol", "Class", "Subclass", "Method", "X..Co>
colnames(AMR_out) <- c("Scope", "Type", "Subtype", "Element", "Class", "Subclass", "Method", "Coverage", ">
...
vspace{1em}
\needspace{15\baselineskip}
\textbf{d) Gener koblet til resistens, biocider, stress, effluks, virulens:} $\,\geq\,$ 60\% dekning og $\>
Gener basert på Plus databasen av Bacterial Antimicrobial Resistance Reference Gene Database BioProject PR>
...
if (grepl("Klebsiella", mlst_species) && length(kleborate_files) > 0) {
    ...
    knitr::kable(
        ...
        kableExtra::kable_styling(
            ...
            column_spec(2, width = "4cm") %>%
        print()
        cat("Kolistinresistens er bestemt av trunkering av/eller manglende mgrB- og pmrB-kjernegener. OmpK35- >
    ...
    knitr::kable(
        ...
        kableExtra::kable_styling(
            ...
            column_spec(2, width = "4cm") %>%
        print()
        cat("0 = negative for all of yersiniabactin (ybt), colibactin (clb), aerobactin (iuc); 1 = yersiniabac>
